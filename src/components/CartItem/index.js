...
const CartItem = ({
  ...
  onPressDecrease,onPressIncrease, 
}) => {
    return (
      <View style={styles.cartItem}>
      <TouchableOpacity onPress={onPressItem}>
      <Image style={styles.productImage} resizeMode='contain'
        source={itemImage} />
        </TouchableOpacity>
      <View style={styles.itemDetails}>
        ...
        <View style={styles.lowerSection}>
          <View style={styles.row}>
            ...
            <FontAwesome onPress={onPressIncrease}  name='plus-circle' style={styles.countIcon} />
          </View>
        </View>
      </View>
    </View>
