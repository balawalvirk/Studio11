...
const InputField = ({
    ...
    labelStyle = {}, multiline, numoflines, searchIcon, searchIconstyle, defaultValue,
    suffixIcon, suffixIconName, suffixIconstyle,
    inputStyle
}) => {
    return (
        <View style={[{ width: width(80) }, containerStyles ? containerStyles : {}]}>
            ...
            <View style={[styles.mainInputView, inputStyle]}>
                ...
                {suffixIcon ? <View style={styles.iconView} >
                    <Icon name={suffixIconName} style={[styles.searchIcon, suffixIconstyle]} />
                </View> : null}
            </View>
