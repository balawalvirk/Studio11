...
const ScheduleCard = ({
  barberName, cuttingName, scheduledTime, timeLeft, appointmentImage, onpressScheuledCard, onpressMessage,
  scheuledCardStyle = {},
  additionalNotes
}) => {
  return (
    <View style={[styles.scheuledCard,scheuledCardStyle]}>
      <Pressable style={styles.upperSection}
        onPress={onpressScheuledCard}>
        <View style={{width:width(50)}}>
          <Text style={styles.whiteText}>Name: <Text style={styles.white50}>{barberName}</Text></Text>
      ...
      <View style={styles.bottomSection}>
        ...
        <Button containerStyle={{ width: width(25), marginRight: 0, marginTop: height(2) }} 
        onPress={onpressMessage} title={'Message'} />
      </View>
    </View>
  );
};
