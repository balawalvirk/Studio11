        ...
        <ScreenWrapper scrollEnabled transclucent statusBarColor={AppColors.transparent}
            ...
            <View style={styles.mainViewContainer}>
                ...
                <InputField value={email.trim()}
                    ...
                    label={'Email'} placeholder={'Enter your Email'} fielderror={emailerror}
                />
                <InputField secureTextEntry value={password}
                    ...
                    label={'Password'} placeholder={'Enter your Password'} fielderror={passworderror}
                />
                ...
                <View style={styles.buttonRow}>
                    <Button planButton={userType != 'Customer'} gradientContainerStyle={{ borderRadius: width(2) }} containerStyle={userType == 'Customer' ? { width: '30%' } :
                        { width: '30%', backgroundColor: AppColors.iconColor, borderRadius: width(2) }}
                        textStyle={userType == 'Customer' ? null : { color: AppColors.black }} title='Customer'
                        onPress={() => setuserType('Customer')} />
                    <Button planButton={userType != 'Barber'} gradientContainerStyle={{ borderRadius: width(2) }} containerStyle={userType == 'Barber' ? { width: '30%' } :
                        { width: '30%', backgroundColor: AppColors.iconColor, borderRadius: width(2) }}
                        textStyle={userType == 'Barber' ? null : { color: AppColors.black }} title='Barber'
